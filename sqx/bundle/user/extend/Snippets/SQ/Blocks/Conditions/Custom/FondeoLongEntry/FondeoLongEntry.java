/*
 * Condicion Long — usar en AlgoWizard pestaña Long entry.
...
@BuildingBlock(name="Fondeo Long Entry", display="Fondeo Long Entry (EMA cross)", returnType = ReturnTypes.Boolean)
@Help("True cuando FondeoEMAcross dispara senal long (cruce alcista en sesion).")
public class FondeoLongEntry extends ConditionBlock {
