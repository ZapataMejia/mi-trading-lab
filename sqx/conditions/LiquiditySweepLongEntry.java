/*
 * Condicion Long — AlgoWizard Buy entry.
...
@BuildingBlock(name="Liquidity Sweep Long Entry", display="LiqSweep Long Entry (lb#LookbackBars#)", returnType = ReturnTypes.Boolean)
@Help("True cuando LiquiditySweep dispara senal long (sweep low + reclaim en sesion).")
@ParameterSet(set="LookbackBars=36,RiskPct=1.5,TPRatio=1.5,SlBufferPips=3,MaxTradesPerDay=1,SessStart=700,SessEnd=1400")
public class LiquiditySweepLongEntry extends ConditionBlock {
